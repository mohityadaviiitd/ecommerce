# Generated by Django 3.2.7 on 2021-11-10 13:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='estore.products')),
                ('wishlist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'wishlist',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pdf', models.FileField(default=estore.models.default_pdf, upload_to=estore.models.get_pdf)),
        ...
        migrations.AddField(
            model_name='products',
            name='seller',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='estore.sellers'),
        ),
        migrations.CreateModel(
            name='ProductImages',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='estore.sellers')),
            ],
            options={
